...
| KL divergence | Wrong expectations → KL divergence → lower NGDP. Least informative prior beats rational expectations. Also: KL divergence can serve as the price detector (same qualitative properties as dD/dS), formally connecting the price mechanism to GAN objectives | [2014 H1](../sources/2014-h1-theoretical-foundations.md), [Apr 2018](../raw/2018/04/the-kl-divergence-as-price.md) | [[information-equilibrium]], [[information-bottleneck]] |
